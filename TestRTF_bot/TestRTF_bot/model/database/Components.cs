...
{
    public class Components<T> : SortedReadonlyList<T, int> where T : IComponent
    {
        public Components(IEnumerable<T> collection, Func<T, int> predicate) : base(collection, predicate)
        {
